...
🔧 **Aspiring DevOps Engineer** with hands-on experience in web systems and a growing focus on Linux, cloud infrastructure, automation, and reliable, scalable platforms.  
📊 My background in data science helps me approach engineering problems with structured thinking, metrics, and system-level reasoning.
...
An award-winning **WordPress-based digital wellness platform** designed to modernize access to Ayurvedic healthcare services and products.
